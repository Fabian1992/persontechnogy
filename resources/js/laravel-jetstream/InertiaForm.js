...
class InertiaForm {
    ...
    hasErrors() {
        return this.inertiaPage().props.errorBags[this.__options.bag] &&
               Object.keys(this.inertiaPage().props.errorBags[this.__options.bag]).length > 0;
    }

    error(field) {
        if (! this.hasErrors() ||
            ! this.inertiaPage().props.errorBags[this.__options.bag][field] ||
            this.inertiaPage().props.errorBags[this.__options.bag][field].length == 0) {
            return;
        }

        return this.inertiaPage().props.errorBags[this.__options.bag][field][0];
    }
